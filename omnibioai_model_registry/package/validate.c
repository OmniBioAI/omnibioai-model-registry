...
#define __pyx_kp_u_Model_package_missing_required_f __pyx_string_tab[3]
...
#define __pyx_n_u_REQUIRED_FILES __pyx_string_tab[9]
...
#define __pyx_n_u_missing __pyx_string_tab[27]
#define __pyx_n_u_omnibioai_model_registry_package_2 __pyx_string_tab[28]
#define __pyx_n_u_pathlib __pyx_string_tab[29]
...
*/
    ...
    __pyx_t_4 += __Pyx_PyUnicode_GET_LENGTH(__pyx_t_11[1]) + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_11[3]);
    #endif
    __pyx_t_12 = 0;
    #if __Pyx_PyUnicode_Join_CAN_USE_KIND_AND_LENGTH
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } str_length_index[] = {{1},{6},{1},{38},{31},{39},{44},{4},{4},{14},{15},{20},{12},{8},{8},{10},{8},{12},{8},{13},{18},{18},{6},{6},{1},{5},{6},{7},{41},{7},{3},{6},{10},{22},{6},{11}};
    const struct { const unsigned int length: 6; } bytes_length_index[] = {{57}};
    /* compression: none (526 bytes) */
static const char bytes[] = ".. In: ?Model package missing required files: omnibioai_model_registry.errorsomnibioai_model_registry.package.layoutomnibioai_model_registry/package/validate.pyNonePathREQUIRED_FILESValidationError__Pyx_PyDict_NextRef__annotate____func____main____module____name____qualname____test___is_coroutineasyncio.coroutinescline_in_tracebackerrorsexistsfitemslayoutmissingomnibioai_model_registry.package.validatepathlibpopreturnsetdefaultvalidate_package_filesvaluesversion_dir\320\000(\250\t\260\021\330\004\016\210a\210r\220\024\220U\230/\250\023\250E\260\034\270R\270r\300\027\310\001\330\004\007\200q\330\010\016\210o\230Q\330\0144\260A\260^\3001\300A";
    PyObject *data = NULL;
